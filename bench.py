...
print("euro_vanilla_call", str(timeit(bench_euro_vanilla_call, number=1000)/1000.))
print("euro_vanilla_put", str(timeit(bench_euro_vanilla_put, number=1000)/1000.))
print("euro_vanilla: " + str(timeit(bench_euro_vanilla, number=1000)/1000.))
print("black_scholes_call_div", str(
    timeit(bench_black_scholes_call_div, number=1000)/1000.))
print("black_scholes_put_div", str(
    timeit(bench_black_scholes_put_div, number=1000)/1000.))
print("euro_vanilla_dividend: " +
      str(timeit(bench_euro_vanilla_dividend, number=1000)/1000.))
