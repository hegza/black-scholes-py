...
class MyTest(unittest.TestCase):
    ...
    def test_non_divident_paying_sympy(self):
        self.assertAlmostEqual(euro_call_sym(50, 100, 1, 0.05, 0.25),
                               -25.0*erf(1.22379436111989*sqrt(2)) - 22.5614712250357 +
                               47.5614712250357*erf(1.34879436111989*sqrt(2))
                               )

        self.assertAlmostEqual(euro_put_sym(50, 100, 1, 0.05, 0.25),
                               -25.0*erf(1.22379436111989*sqrt(2)) + 22.5614712250357 +
                               47.5614712250357*erf(1.34879436111989*sqrt(2))
                               )

        self.assertAlmostEqual(sym_euro_vanilla(50, 100, 1, 0.05, 0.25, option='put'),
                               -25.0*erf(1.22379436111989*sqrt(2)) + 22.5614712250357 +
                               47.5614712250357*erf(1.34879436111989*sqrt(2))
                               )
        pass
